...
const SinglePage = () => {
  return (
    <MainLayout>
      <div className="mt-20 container mx-auto px-4 md:max-w-5xl">
        <div className="flex justify-center items-center gap-x-10 py-3 text-sm md:text-base font-semibold">
          <span>July 3, 2024</span>&#8226;
          <span className="underline">Hari Bahadur</span>&#8226;
          <span>Category</span>
        </div>
        <h1 className="text-xl md:text-2xl lg:text-4xl font-semibold md:font-bold py-2">
          The pros and cons of business agency
        </h1>
        <div className="md:max-w-5xl flex justify-center items-center flex-col">
          <img src="/hero.jpeg" alt="Blog Image" className="rounded-lg my-2 max-w-5xl" />
